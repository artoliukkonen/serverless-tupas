import getTupas from './tupas/get-tupas';
import getValidateTupas from './tupas/get-validate-tupas';

// Map your functions to http events here
const RESOURCE_MAP = {
  '/': { GET: getTupas },
  '/ok': { GET: getValidateTupas },
  '/cancel': { GET: getValidateTupas },
  '/reject': { GET: getValidateTupas },
};
